...
static void testMixAndGain() {
    float output[] = { 0.25f, -0.5f, 1.0f, 0.0f };
    const float input[] = { 0.75f, 0.25f, 1.0f, -1.0f };
    yarg::audio::mixAdd(output, input, 4);
    yarg::audio::applyGain(output, 4, 0.5f);
